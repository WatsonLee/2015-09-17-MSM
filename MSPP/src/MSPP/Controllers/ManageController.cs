...
using MSPP.Models;
using MSPP.Services;
using MSPP.Controllers.Tool;

namespace MSPP.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        {
            model.OldPassword += CustomDefine.APPEND_PASSWORD;
            model.NewPassword += CustomDefine.APPEND_PASSWORD;
            model.ConfirmPassword += CustomDefine.APPEND_PASSWORD;
            if (!ModelState.IsValid)
            {
                return View(model);
            }
